...
class AdminAddEdit
{
    ...
    private function handleGET()
    {
        ...
        // Is PRO version
        $is_pro = \WPSynchro\WPSynchro::isPremiumVersion();
        ...
        <div id="wpsynchro-addedit" class="wrap wpsynchro"  v-cloak>
            <h2>WP Synchro <?php echo ( $is_pro ? 'PRO' : 'FREE' ); ?> - <?php ( $id > 0 ? _e('Edit installation', 'wpsynchro') : _e('Add installation', 'wpsynchro') ); ?></h2>
                ...
                <form id="wpsynchro-addedit-form" method="POST" >
                    ...
                    <div class="generalsetup">
                        ...
                        <div class="option">
                            ...
                            <div class="optionvalue">
                                <label><input v-model="inst.type" v-bind:readonly="inst.valid_endpoint" type="radio" name="type" value="pull" v-on:click="inst.valid_endpoint = false" ></input> <?php _e('Pull from remote server to this installation ', 'wpsynchro'); ?></label><br>
                                <label><input v-model="inst.type" v-bind:readonly="inst.valid_endpoint" type="radio" name="type" value="push" v-on:click="inst.valid_endpoint = false" ></input> <?php _e('Push this installation to remote server', 'wpsynchro'); ?></label>                                
                            </div>
                        </div>
                        ...
                        <div v-if="inst.type.length > 0">
                            ...
                            <div class="option">   
                                ...
                                <div class="optionvalue">
                                    <input v-model="inst.site_url" v-bind:readonly="inst.valid_endpoint" type="text" name="website" id="website" value="" placeholder="https://example.com" required> <span v-if="inst.valid_endpoint" class="validstate">&#10003;</span>
                                </div>
                            </div>
                            <div class="option"> 
                                <div class="optionname">
                                ...
                                <div class="optionvalue">
                                    <input v-model="inst.access_key" v-bind:readonly="inst.valid_endpoint" type="text" name="accesskey" id="accesskey" value="" required ></input> <span v-if="inst.valid_endpoint" class="validstate">&#10003;</span>                                                                      
                                </div>                            
                            </div>
                            <p v-if="site_url_is_insecure" class="sslwarning"><b><?php _e('All communication will be encrypted during synchronization. But without SSL (https://), the data retrieved during this configuration will not be encrypted.', 'wpsynchro'); ?></b><br><?php _e('Consider using https:// instead if website supports it.', 'wpsynchro'); ?></p>
                            <div class="errors">
                                <ul>
                                    <li v-for="(errormessage, index) in inst.valid_endpoint_errors">{{errormessage}}</li>
                                </ul>
                            </div>
                            <button v-if="!inst.valid_endpoint" v-on:click.prevent="initiateVerification"><?php _e('Verify website and access key', 'wpsynchro'); ?></button><div v-show="inst.valid_endpoint_spinner" class="spinner"></div>
                        </div>
                    </div>
                            ...
                            <div class="optionvalue">
                                <limited-in-free limittext="<?php _e("Get PRO version now to start doing file synchronization and more!", "wpsynchro") ?>" v-bind:ispro="<?php echo ( $is_pro ? 'true' : 'false'); ?>" >
                                    <div class="optionvaluepart">
                                        ...
                                        <span title="<?php _e('Backup database, synchronize database, synchronize all files from web root level (except wp-admin, wp-includes and WP files in web root)', 'wpsynchro'); ?>" class="dashicons dashicons-editor-help"></span><br>
                                    </div>
                                    <div class="optionvaluepart">
                                        ...
                                        <span title="<?php _e('Synchronize all files from web root level (except wp-admin, wp-includes and WP files in web root)', 'wpsynchro'); ?>" class="dashicons dashicons-editor-help"></span><br>
                                    </div>
                                </limited-in-free>
                    ...
                    <div class="filessyncsetup" v-show="inst.valid_endpoint && inst.sync_files && inst.sync_preset == 'none'">
                    ...
                    <div class="dbsyncsetup" v-show="inst.valid_endpoint && inst.sync_database && inst.sync_preset == 'none'">
                        ...
                        <limited-in-free limittext="<?php _e("Get PRO version now to start doing file synchronization and more!", "wpsynchro") ?>" v-bind:fit="true" v-bind:ispro="<?php echo ( $is_pro ? 'true' : 'false'); ?>" >
                            <div class="option">
                                ...
                                <div class="optionvalue">
                                    <label><input v-model="inst.db_make_backup" type="checkbox" name="db_make_backup" id="db_make_backup" <?php echo ( $is_pro ? '' : 'disabled'); ?> ></input> <?php _e('Backup chosen database tables to file', 'wpsynchro'); ?> <span title="<?php _e('Backup database tables before overwriting them. Will be written to a .sql file that be imported again by phpmyadmin or equal tools.', 'wpsynchro'); ?>" class="dashicons dashicons-editor-help"></span> (<?php _e('Recommended', 'wpsynchro'); ?>)</label>
                                </div>
                            </div>
                        </limited-in-free>
                        ...
                        <p><?php _e('Add your project specific search/replaces.', 'wpsynchro'); ?> <?php _e('Eg. "text_i_want_changed" to "my_new_text"', 'wpsynchro'); ?>.<br><?php _e('Search/replace is done in a case sensitive manner', 'wpsynchro'); ?></p>
                        ...
                        <div class="searchreplaces" >
                            ...
                            <div class="searchreplace" v-for="(replace, key) in fixed_search_replaces">
                                <div class="dashicons dashicons-lock"></div>
                                <div><input v-model="replace.from" type="text" readonly ></input></div>
                                <div><input v-model="replace.to" type="text" readonly ></input></div>                          
                            </div>
                    ...
                    <div class="savesetup" v-if="inst.valid_endpoint">
                        ...
                        <p>
                            <input type="submit" v-if="inst.valid_endpoint" value="<?php _e('Save', 'wpsynchro'); ?>" ></input>
                        </p>
                    </div>
