...
class AdminActivation
{
    ...
    public static function activation()
    {
        ...
        /*
         *  Check sync list database table
         */
        if (file_exists(trailingslashit(dirname(__FILE__)) . 'files/class-sync-list.php')) {
            require_once( 'files/class-sync-list.php' );
            \WPSynchro\Files\SyncList::createSyncListTable();
        }
    }
}
